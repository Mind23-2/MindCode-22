...
from ..trainers import TrainClipGradAccEMA
...
def pretrained(args, model):
    ...
    pretrained = os.path.join(args.model_path, 'best_model.ckpt')
...
def get_train_one_step(args, net_with_loss, optimizer):
    ...
    net_with_loss = TrainClipGradAccEMA(net_with_loss, optimizer, scale_sense=scale_sense,
